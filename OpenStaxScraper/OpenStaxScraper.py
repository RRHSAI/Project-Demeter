...
textbookQuestPages = scrapeUnits(['Review Questions', 'Critical Thinking Questions', 'Test Prep for APÂ®\xa0Courses'], 'https://openstax.org/books/biology-ap-courses/pages/2-review-questions', 'https://openstax.org/books/biology-ap-courses/pages/')
